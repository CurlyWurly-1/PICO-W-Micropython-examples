...
If you are using a breadboard, adding pullup resistors is easy and it also helps to counteract any possible effects of stray capacitance between breadboard lines becoming an issue at high frequencies. Consider that stray capacitance in a breadboard starts to become an issue if you use an IC2 bus speed higher than "fast mode" ( > 400 kbit/sec ).
