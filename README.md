...
N.B. the webpage that you see, is parsed from "windex.html". You can adapt "windex.html" to show whatever you want. If you want to add more variables, look for how "%%i1" is treated in program "weatherStation.py", and where it is defined "windex.html". The idea is that you put placeholder variables in the static html page source, and then in the micropytrhon program, the placeholder variables are replaced with the actual values 
